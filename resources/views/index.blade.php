          ...
          <div class="carousel-inner" style="text-align:right;">
            ...
            <div class="carousel-item active">
              <div class="container">
                <div class="banner_main">
                  <h1 class="banner_taital">ايزوتك الاستشارية وشركاء النهضة</h1>
                  <p class="banner_text">برنامج جهود القومي لتطوير الادارة الاليكتروني ولتيسير وسائل التكنولوجيا الرقمية
                  </p>
                  <div class="btn_main">
                    <div class="contact_bt active "><a href="{{ route('contact') }}">تواصل معنا</a></div>
                  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <p class="blog_text">تقدم هذه المنظمات لعملائها خدمات استشارية مختلفة. في معظم الحالات ، تكون شركة خارجية وترتبط
          مباشرة بشركات عملائها. الاستشارات هي تقديم المشورة اللازمة للبائعين والمصنعين وكذلك للمشترين. يمكنهم الحصول
          على المساعدة في المجالات الفنية والتكنولوجية والخبراء في عملهم. وتتمثل المهمة الرئيسية لمثل هذه الشركة في
          تقديم المساعدة الإدارية فيما يتعلق بالقضايا التي يطرحها العملاء لأنفسهم</p>
    ...
    <div class="services_section_2">
      <div class="row">
        <div class="col-lg-4">
          ...
          <p class="ipsum_text" style="text-align:right;">دراسات التصميم الاولية والمسوحات بأنواعها، دراسات الجدوى
            للمشروعات، التصميمات المعمارية والانشائية لجميع المنشئات، التصميم الحضري والريفي، الاشراف على التنفيذ،
            التخطيط والمتابعة الادارية للمشروعات، متابعة اجراءات تصديق المشروعات</p>
          <div class="icon_box">
            <div class="icon_1"><img src="images/icon-4.png"></div>
          </div>
          <h4 class="selection_text" style="text-align:right;">تقييم الاصول</h4>
          <p class="ipsum_text" style="text-align:right;">تقييم المنشءات والمباني بأنواعها، تقييم الأراضي والمخططات
            بأنواعها، تقييم الآليات والمعدات، تقييم المشروعات</p>
        </div>
        <div class="col-lg-4">
          <div class="icon_box">
          ...
          <p class="ipsum_text" style="text-align:right;">دراسات الأثر البيئي للمشروعات، دراسات تصميم محطات مياه الشرب،
            دراسة ادراة التلوث البيئي بأنواعه، دراسة معالجة المخلفات بأنواعها، دراسات ادارة مياه الأمطار والسيول</p>
          <div class="icon_box">
            <div class="icon_1"><img src="images/icon-5.png"></div>
          </div>
          <h4 class="selection_text" style="text-align:right;">التخصصات الهندسية</h4>
          <p class="ipsum_text" style="text-align:right;">دراسات التصميم الأولية والمسوحات الهندسية، تصميم المنشئات
            الهندسية، دراسات تقييم الوضع الراهن لمنشئات الهندسية، دراسات اعادة تأهيل المنشئات الهندسية الصناعية، دراسات
            الجدوى الفنية للآليات والمعدات</p>
        </div>
        <div class="col-lg-4">
          <div class="icon_box">
          ...
          <p class="ipsum_text" style="text-align:right;">تقييم الوضع الاداري الحالي ودراسات تحديد الفجوة، التخطيط
            الاستراتيجي للاداري نحو الفضاء الرقمي، الاشراف على تنفيذ التحول التكنولوجي، التصميم والاشراف على تنفيذ
            مشروعات الحوسبة</p>
        </div>
      </div>
    </div>
...
<div class="contact_section layout_padding" dir="rtl" lang="ar">
  <div class="container">
    ...
    <p class="contact_text" style="text-align:right;">نحن نسعى ان نقدم لك الأفضل اذا واجهتك اي مشكلة لا تتردد في التواصل
      معنا</p>
          ...
          <div class="map_main">
            <div class="map-responsive">
              <iframe
                ...
                style="border:0; width: 100%;" allowfullscreen="" width="600" height="400" frameborder="0"></iframe>
            </div>
          </div>
        </div>
      </div>
